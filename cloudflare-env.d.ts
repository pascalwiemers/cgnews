/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: be129991623447f2f59ba29f980c9ea7)
// Runtime types generated with workerd@1.20260617.1 2026-06-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	CGNEWS_DB_RUNTIME: "d1";
	DATABASE_URL: string;
	NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: string;
	CLERK_SECRET_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* cgnews */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CGNEWS_DB_RUNTIME" | "DATABASE_URL" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}

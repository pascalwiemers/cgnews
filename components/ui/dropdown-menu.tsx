...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto font-mono text-[11px] opacity-60", className)}
      {...props}
    />
  )
}
